	...
	<main id="main" class="site-main">
		<?php if ( !is_front_page() && is_home() ) : ?>
			<header class="entry-header">
				<h6 class="entry-title" style="margin-bottom: 20px;">Community Blogs</h6>
				<?php //if( $post->ID == 4253 ) : ?>
					<p>Read blogs by Lemons-Aid community members that relate to teaching, learning, and parenting from a biblical worldview.</p>
				<?php //endif; ?>
			</header><!-- .entry-header -->
		<?php endif; ?>
		<?php if ( have_posts() ) : ?>
