					        ...
					        <div class="col9 member-form-main">
					            <form  method="post">
					                ...
					                <div class="member-header">
					                  <input type="hidden" id="uid" name="uid" value="<?php echo $currentuserid; ?>" >
					                ...
					                <div class="row row6">
					                    ...
					                    <div class="col12 text-center">
											<?php
											if($currentuserid > 0){
												echo '<button class="sbmt-btn" type="button" onclick="updatefunction()">updated Studyif</button>';
											}else{
												echo '<button class="sbmt-btn" type="button" onclick="trailfunction()">Join Studyif</button>';
											}   
											?>
					                    </div>
					                </div>
