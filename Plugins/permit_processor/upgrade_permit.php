...
?>
    ...
    <div class="wrapper-conete">
        ...
        <div class="header-title-btn w-100">
            ...
            <div class="right-col col-sm-6">
                <?php
                if ($upusers != '[]') {
                    echo '<button class="bt-1 upgradebtn" onclick="action_permit_reassign(' . $upusers . ')">Upgrade Permit #</button>';
                } ?>
                <button class="bt-2 " id="btnExport">Export for Print </button>
                <button class="bt-3 btnNextpage" userid="<?php echo $upusers; ?>">Continue to Next Step</button>
            </div>
    ...
    <script type="text/javascript">
        $(".btnNextpage").click(function() {
            ...
            if (udata == '' && sessdata != '[]') {
                if (confirm("Are you sure to skip the upgrade permit.")) {
                    $(".stepbtnup").addClass("active");
                    window.location.href = '/wp-admin/admin.php?page=replacepermit';
                }
            } else {
                $(".stepbtnup").addClass("active");
                window.location.href = '/wp-admin/admin.php?page=replacepermit';
