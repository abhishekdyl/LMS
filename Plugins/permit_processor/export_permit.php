...
?>
        ...
        <div class="header-title-btn w-100">
            ...
            <div class="right-col col-sm-6">
                ...
                <form method="POST">
                    ...
                    <button id="wexbtn" class="bt-2 d-none" name="wslexp">Export WSLCB Reports </button>
                </form>
    ...
    <input type="hidden" id="totalselected" value=" <?php echo sizeof($_SESSION['expuserid']); ?> " />
    <input type="hidden" id="totaladdedids" value=" <?php echo implode(',', array_keys($_SESSION['expuserid'])); ?> " />
    ...
    <script>
        ...
        class csvExport {
            ...
            static safeData(td) {
                let data = td.textContent.trim().replace('New', '<br>').replace('Upgrade', '<br>').replace('Replace', '<br>').replace(/\s+/g, " ").replace('<br> ', '  ');
        ...
        const btnExport2 = document.querySelector("#btnExport");
        const btnExport = document.querySelector("#wexbtn");
