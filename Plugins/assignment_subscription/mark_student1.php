...
$activetab=1;
if(isset($_SESSION['markdata']) && !empty($_SESSION['markdata']['tabbtn'])){
...
/* table.dataTable.table-striped > tbody > tr td:first-child, table.dataTable.table-striped > thead > tr th:first-child {
 ...
 <!-- General Tab -->
	...
	<!-- <div class="table-responsive"> -->
				...
				<div class="row">
					...
					// General userid IN (SELECT userid FROM {assign_subs_status} WHERE ispriority=0) AND
				...
				<script>
					...
					// 	   $("#target_general").val(settings.json.iGeneralTarget);
				...
				<script>
				   function selectEnable_general(elem){
					...
					// var myEl = document.getElementById('tutor_edit_list').value;
  ...
  <!-- <div class="table-responsive"> -->
				...
				<script>
					...
					// 	   $("#target_priority").val(settings.json.iPriorityTarget);
...
<script>
	$(document).ready(function(){
		...
		// $("#course_id_archive").trigger("change");
...
<!-- <script>
$(document).on("change", ".filterupdated", function(){
	var Input1 = document.getElementById('tab-btn-1');
			var Input2 = document.getElementById('tab-btn-2');
			var Input3 = document.getElementById('tab-btn-3');
			var th = document.querySelectorAll("th");
			var tabll = document.querySelectorAll("table");

			// console.log(th);
			if(Input1.checked === true){
				th[1].style.setProperty("width", "100px", "important");
				th[3].style.setProperty("width", "200px", "important");
				//th[1].style.setProperty("width", "200px", "important");
				//th[1].style.setProperty("max-width", "200px", "important");
				tabll[0].style.width   = "100%";

			}

		    else if (Input2.checked === true){	
				//th[5].style.setProperty("width", "262px", "important");
				//th[5].style.setProperty("max-width", "262px", "important");
				th[9].style.setProperty("width", "100px", "important");
				th[6].style.setProperty("width", "150px", "important");
				tabll[1].style.width   = "100%";
				
			}

		    else if (Input3.checked === true){
				//console.log(th[11]);
				//th[11].style.setProperty("width", "262px", "important");
				//th[11].style.setProperty("max-width", "262px", "important");
				th[15].style.setProperty("width", "100px", "important");
				th[12].style.setProperty("width", "150px", "important");
				tabll[2].style.width   = "100%";
