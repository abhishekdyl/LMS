 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_assignfeedback_adaptive_subplugin extends restore_subplugin {
     ...
     * @param mixed $data
     */
    public function process_assignfeedback_adaptive_grade($data) {
        global $DB;
        ...
        $DB->insert_record('assignfeedback_adaptive', $data);

        $this->add_related_files(
            'assignfeedback_adaptive',
            'feedback',
            'grade',
            null,
            $oldgradeid
