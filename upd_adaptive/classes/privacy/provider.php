...
namespace assignfeedback_adaptive\privacy;
...
class provider implements
    ...
    public static function get_metadata(collection $collection) : collection {
        ...
        $collection->add_database_table('assignfeedback_adaptive', $data, 'privacy:metadata:tablesummary');
    ...
    public static function export_feedback_user_data(assign_plugin_request_data $exportdata) {
        ...
        if ($comments && !empty($comments->commenttext)) {
            $currentpath = array_merge(
                ...
                [get_string('privacy:commentpath', 'assignfeedback_adaptive')]
            );
            ...
            writer::with_context($exportdata->get_context())->export_area_files($currentpath,
                assignfeedback_adaptive_COMPONENT, assignfeedback_adaptive_FILEAREA, $gradeid);
        }
    }
    ...
    public static function delete_feedback_for_context(assign_plugin_request_data $requestdata) {
        ...
        $fs = get_file_storage();
        $fs->delete_area_files($requestdata->get_context()->id, assignfeedback_adaptive_COMPONENT,
            assignfeedback_adaptive_FILEAREA);
    ...
    public static function delete_feedback_for_grade(assign_plugin_request_data $requestdata) {
        ...
        $fs = new \file_storage();
        $fs->delete_area_files($requestdata->get_context()->id, assignfeedback_adaptive_COMPONENT,
            assignfeedback_adaptive_FILEAREA, $requestdata->get_pluginobject()->id);

        $DB->delete_records('assignfeedback_adaptive', ['assignment' => $requestdata->get_assignid(),
    ...
    public static function delete_feedback_for_grades(assign_plugin_request_data $deletedata) {
        ...
        $DB->delete_records_select('assignfeedback_adaptive', "assignment = :assignment AND grade $sql", $params);
    }
}
