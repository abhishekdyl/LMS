...
echo '<div class="btntopdf float-right"><button class="btn btn-success" onclick="printDiv(`tableid`)">Click to Print here</button></div>
<div id= "tableid" >
...
if (!empty($table->data)) {
    // echo html_writer::start_tag('div', array('id'=>'tableid'));
