...
<section class="elementor-custom-margin">
    <div class="container">
        <div class="row">
            <?php
            global $wpdb;
            $sql = "SELECT wp_id FROM {$wpdb->prefix}course_category_map WHERE wp_id IN ( SELECT term_id FROM {$wpdb->prefix}term_taxonomy WHERE parent='$sub_cate')";
            ...
            if (count($all_cat)) {
                ...
                foreach ($all_cat as $cat) {
                    ...
                    $sql_chk = "SELECT * FROM {$wpdb->prefix}term_taxonomy WHERE term_id='$term_id'";
                    ...
                    //      $url=get_page_link(1325).'&sub_cate='.$parent; //get_term_link($cat->term_id);
                    // }
