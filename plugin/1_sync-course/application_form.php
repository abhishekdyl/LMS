...
if(is_user_logged_in()){
    wp_redirect( home_url('/?page_id=837') );//('location:','/');
    exit();
}
                ...
                <form method="post" id="user-register-form">
                    <div class="wrap">
                        <div class="floating-label-group input-parent">
                            <input type="text" id="fname" name="fname" data-name="First name" class="form-control required" autocomplete="off"  />
                            <label class="floating-label">First Name</label>
                        </div>
                        <div class="floating-label-group input-parent">
                            <input type="text" id="lname" name="lname" data-name="Last name" class="form-control required" autocomplete="off"  />
                            <label class="floating-label">Last Name</label>
                        </div>
                        <div class="floating-label-group input-parent">
                            <input type="text" id="username" name="username" data-name="Username" class="form-control required" autocomplete="off"  />
                            <label class="floating-label">Username</label>

                        </div>
                        <div class="floating-label-group input-parent">
                            <input type="email" id="email" name="email" data-name="Email" class="form-control required" autocomplete="off"  />
                            <label class="floating-label">E-mail</label>
                        </div>
                        <div class="floating-label-group input-parent">
                            <input type="password" id="#password3-field" name="password" data-name="Password" class="form-control required" autocomplete="off"  />
                        ...
                        <div class="floating-label-group input-parent">
                            <input type="password" id="repassword" name="crmpassword" data-name="Confirm Password"  class="form-control required" autocomplete="off"  />
                            <a href="javascript:void(0);" toggle="#password3-field" class="fa fa-fw fa-eye field-icon toggle-password text-decoration-none text-dark"></a>
                            <label class="floating-label">Re-password</label>
                        </div>
                        <input type="submit" name="submit" value="Apply Now" class="w-100 fs-4 fw-bold" />
                         <div class="mt-3 text-center">
                            <span>Already have an account?</span><span><a href="<?php echo home_url('/?page_id=1144');?>" class="ms-2">LOGIN</a></span>
                        </div>
                   ...
                   var responsedata=JSON.parse(response);
                    if(responsedata.status==false){
                        ...
                        $('.success-msg').html(`<div class="alert alert-success text-center mt-3">
                                                    <strong>Error!</strong> ${responsedata.msg}
                                                </div>`);
                        ...
                        // var location = responsedata.pagelink ;
                        ...
                        $('.success-msg').html(`<div class="alert alert-success text-center mt-3">
                                    ...
                                    // console.log('pageidddddddddd ', responsedata.pageid);
