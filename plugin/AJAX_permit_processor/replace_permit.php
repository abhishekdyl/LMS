...
?>
        ...
        <div class="dex table-responsive">
            <section id="table-section" class="license w-100">
                ...
                <table id="headerTable" class="table table-striped table-hover class_12">
                    <thead>
                        <th style="width: 20%;">
                            <div class="title-parent d-flex"><input type="checkbox" id="checkAll" />Name</div>
                        </th>
                        <th>Permit</th>
                        <th>Sex</th>
                        <th>DOB</th>
    ...
    <input type="text" id="totalselected" value=" <?php echo sizeof($_SESSION['repusersid']); ?> " />
    <input type="text" id="totaladdedids" value=" <?php echo implode(",", array_keys($_SESSION['repusersid'])); ?> " />
            ...
            jQuery.ajax({
                ...
                success: function(response) {
                    ...
                    if (dataa) {
                        ...
                        window.location.href = 'https://staging-soqorura.temp312.kinsta.cloud/wp-admin/admin.php?page=exportpermit';
                    }
                }
            });
        }
