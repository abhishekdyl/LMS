                ...
                <table id="headerTable" class="table table-striped table-hover class_12">
                    ...
                    <tr>
                        <td>
                            ...
                            <small>Katherine@mail.com</small>
                        </td>
                        <td>132546978546132</td>
                        <td>F</td>
                        <td>
                            04/12/2023<br>
                        </td>
       ...
       $("#checkAll").click(function() {
        ...
        $(document).ready(function() {
            ...
            $(".backToStudent").click(function() {
                ...
                window.location.href = 'https://staging-soqorura.temp312.kinsta.cloud/wp-admin/admin.php?page=assignpermit';
            });
