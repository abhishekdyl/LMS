    ...
    <div class="wrapper-conete">
        ...
        <div class="header-title-btn w-100">
            ...
            <div class="right-col col-sm-6">
                ...
                <button class="bt-1" onclick="action_permit_assign_new(<?php echo $npusers; ?>)">Assign Permit #</button>
            ...
            <section id="table-section" class="license w-100">
                ...
                <script type="text/javascript">
                    ...
                    $(".btnNextpage").click(function() {
                        ...
                        window.location.href = 'https://staging-soqorura.temp312.kinsta.cloud/wp-admin/admin.php?page=upgradepermit';
                    });
