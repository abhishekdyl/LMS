...
<head>
    ...
    <script>
        ...
        var apiCall = function(apiMethod) {
            if (apiMethod === 'getCompanyInfo') {
            ...
            } else if (apiMethod === 'refreshToken') {
                // AJAX Request to refresh token
                $.ajax({
                    type: "POST",
                    url: "refreshToken.php",

                    success: function(response) {
                        // Handle refresh token response if needed
                    },
                    error: function(xhr, status, error) {
                        console.error('AJAX request failed:', status, error);
                    }
